...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#f1f5f9' }}>
      ...
      <aside
        className={`
          fixed md:sticky top-0 h-screen z-50 flex flex-col w-60 shrink-0 no-print
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <button onClick={() => setMenuOpen(!menuOpen)} className="p-1 rounded text-slate-400 hover:text-white transition-colors">
